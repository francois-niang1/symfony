 ...
 */
final class Version20220925093745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires ADD user_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires DROP user_id, CHANGE date date TIME NOT NULL');
    }
}
